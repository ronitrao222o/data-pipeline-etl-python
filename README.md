...
2. Phase 2: add data-quality checks, CLI improvements, and richer sample datasets
3. Phase 3: add orchestration-ready features such as scheduled runs and environment-based config
4. Phase 4: introduce analytics queries, dashboards, or warehouse-oriented outputs
5. Phase 5: add containerization, linting, and more production-style developer tooling
